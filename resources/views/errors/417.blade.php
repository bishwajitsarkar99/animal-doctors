            ...
            <div class="p-3 m-3 text-center">
                <div class="card p-4 rounded-4">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            @auth
                                <img class="img-profile" style="width:200px;height:200px;" src="/image/417.jpg" alt="error-image">
                            @endauth
                        </div>
                        <div class="col-xl-3">
                            @auth
                                <h1 class="mt-2  display-1 fw-6 px-4 text-lg text-gray-500 border-r border-gray-400 tracking-wider error-code-darkgreen">417</h1>
                            @endauth
                        </div>
                        <div class="ml-4 text-lg text-gray-500 uppercase tracking-wider error-message" style="color:black;">
                            @auth
                                <span style="color:orange;font-size: 3vw;"><strong>Edit</strong></span> permission is blocked.</span>                 
                            @endauth   
                        </div>
                    </div>
                    <hr>
