            ...
            <div class="p-3 m-3 text-center">
                <div class="card p-4 rounded-4 bg_skeletone">
                    <div class="row">
                        ...
                        @else
                            <h4 class="display-6 text-bold top-skeleton" style="font-size: 1.5vw;font-weight: 700;">Page access permission abort(403) is !</h4>
                        @endauth
                        <div class="col-xl-3">
                            @auth
                            ...
                            @else
                                ...
                                <span class="display-6 text-bold fw-6 text-lg text-gray-500 user text-capsule">No User</span>
                            @endauth
                        </div>
                        <div class="col-xl-6">
                            @auth
                        ...
                        <div class="ml-4 text-lg text-gray-500 uppercase tracking-wider error-message" style="color:orangered;">
                            ...
                            @else
                                <span class="small-capsule" style="font-size: 3vw;"><strong> Not Allowed</strong></span>                  
                            @endauth   
                        </div>
                    </div>
                    <hr>
                    <div>
                        <a class="btn btn-success rounded-5 btn-capsule px-5" type="button" href="{{ url('/common-user-login') }}"> Go Back</a>
                    </div>
                </div>
            </div>
        </div>
