            ...
            <div class="p-3 m-3 text-center">
                <div class="card p-4 rounded-4">
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            @auth
                                <h1 class="mt-2  display-1 fw-6 px-4 text-lg text-gray-500 border-r border-gray-400 tracking-wider error-code-darkgreen">419</h1>
                            @endauth
                        </div>
                        <div class="ml-4 text-lg text-gray-500 uppercase tracking-wider error-message" style="color:darkslategray;">
                            @auth
                                <span style="color:#eecd18;font-size: 3vw;"><strong>My Sql</strong></span> data export permission is blocked.</span>                 
                            @endauth   
                        </div>
                    </div>
                    <hr>
