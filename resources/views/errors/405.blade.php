            ...
            <div class="p-3 m-3 text-center">
                <div class="card p-4 rounded-4">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <img class="img-profile" style="width:200px;height:200px;" src="/image/Delete data.png" alt="error-image">
                        </div>
                        <div class="col-xl-3">
                            <h1 class="mt-2  display-1 fw-6 px-4 text-lg text-gray-500 border-r border-gray-400 tracking-wider error-code-darkgreen">405</h1>
                        </div>
                        <div class="ml-4 text-lg text-gray-500 uppercase tracking-wider error-message" style="color:black;">
                            <span style="color:orange;font-size: 3vw;"><strong>Delete</strong></span> permission is not allowed.</span>                  
                        </div>
                    </div>
                    <hr>
                    <div>
