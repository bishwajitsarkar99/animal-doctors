        ...
        <div class="container">
            <div class="p-3 m-3 text-center">
                <div class="card p-4 rounded-4">
                    <div class="row">
                        @auth
                            <h4 class="display-6 text-bold" style="color:darkslategray;font-size: 1.5vw;font-weight: 700;">You are not able to access the page !</h4>
                        @endauth
                        <div class="col-xl-3">
                            @auth
                                ...
                                <span class="display-6 text-bold fw-6 text-lg text-gray-500 auth_user" style="color:darkslategray;font-weight: 700;">Email : {{ auth()->user()->login_email}}</span>
                            @else
                        ...
                        <div class="col-xl-3">
                            @auth
                                <h1 class="mt-2  display-1 fw-6 px-4 text-lg text-gray-500 border-r border-gray-400 tracking-wider error-code-darkgreen">423</h1>
                            @endauth
                        </div>
                        <div class="ml-4 text-lg text-gray-500 uppercase tracking-wider error-message" style="color:darkslategray;">
                            @auth
                                <span style="color:#eecd18;font-size: 3vw;"><strong>MySql</strong></span> supplier data permission is blocked.</span>                 
                            @endauth   
                        </div>
                    </div>
                    <hr>
