...
<a class="nav-link_cgrMenu dropdown-toggle ty {{setting('acc_report_title_display')}}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <i class="fa-solid fa-folder-open fa-beat"></i> <span class="acc_rep ps-1" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Click')}}">
    ...
    <li>
        <div class="collapse" id="report_" aria-labelledby="headingTwo" data-bs-parent="#report_">
            ...
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('blance_sheet_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Blance-Sheet')}}">
                ...
                <a class="nav-link underline" href="{{setting('trial_blance_sheet_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Trial-Balance-Sheet')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('trial_blance_sheet_visual')}}">{{__('translate.Trial Balance Sheet')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('financial_statement_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Financial-Statement')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('financial_statement_visual')}}">{{__('translate.Financial Statement')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('income_statement_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Income-Statement')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('income_statement_visual')}}">{{__('translate.Income Statement')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('cash_flow_statement_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Cash Flow-Statement')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('cash_flow_statement_visual')}}">{{__('translate.Cash Flow Statement')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('petty_cash_statement_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Petty Cash-Statement')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('petty_cash_statement_visual')}}">{{__('translate.Petty Cash Statement')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('p_l_statement_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Profit or Loss Statement')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('p_l_statement_visual')}}">{{__('translate.P/L Statement')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('tabular_analycis_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Accounting Report Table Analycis')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('tabular_analycis_visual')}}">{{__('translate.Tabular Analycis')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('table_blance_sheet_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Table of Blance-Sheet')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('table_blance_sheet_visual')}}">{{__('translate.Table of Blance Sheet')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('report_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Report Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
            ...
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('monthly_report_view_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Monthly Report')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('monthly_report_view_visual')}}">{{__('translate.Monthly Report View')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('monthly_report_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
            ...
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('daily_report_view_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Daily Report')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('daily_report_view_visual')}}">{{__('translate.Daily Report View')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('daily_report_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
