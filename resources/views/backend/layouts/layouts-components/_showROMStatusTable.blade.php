<div class="offcanvas offcanvas-end custom-offcanvas offcanvas-rom-card offcanvas-hidden component-focus" data-bs-backdrop="static" tabindex="-1" id="offcanvasRom" aria-labelledby="offcanvasRightLabel">
    ...
    <x-CustomOffCanvas.OffCanvasHeader className="offcanvas-header custom-offcanvas-header">
        <div class="head setting-head">
            <span class="logo-status">
                <svg width="50px" height="30px" fill="#888" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 375.4">
    ...
    <x-CustomOffCanvas.OffCanvasBody bodyClassName="offcanvas-body">
        <div class="row mb-2">
            <div class="col-sm-12">
                <div id="selectedId">
                    <select class="form-select" size="6" aria-label="size 6 select example" id="tablePrefixFilter">
                        ...
                        <option class="custom-select-optation" value="NavBarPivotTableMenuCard">Pivot Table Nav Bar Menu Card</option>
                        <option class="custom-select-optation" value="NavBarStockMenuCard">Stock Nav Bar Menu Card</option>
                        <option class="custom-select-optation" value="NavBarSupplierMenuCard">Supplier Nav Bar Menu Card</option>
                        <option class="custom-select-optation" value="OffCanvasSettingDrag">Setting Off Canvas</option>
                        <option class="custom-select-optation" value="OffCanvasSettingDrag, OffCanvasRAMDrag">RAM Off Canvas</option>
                        <option class="custom-select-optation" value="ramUsageTable">RAM Usage Table</option>
                ...
                <div>
                    ...
                    <ul class="box-container" id="romTable">
                        <li class="box-container-row">
                            ...
                            <div class="card panel" id="romTableBox">
                                <div class="row mb-1">
                                    <div class="col-sm-9">
                                        <x-Inputs.SearchInput.Search parentClass="input-search-box" childClass="icon-box" searchSvgWidth="20" searchSvgHeight="20" searchSvgFill="white" searchSvgStroke="rgb(170, 170, 170)" searchSvgStrokeWidth="2" 
                                            searchClass="form-control form-control-sm font-weight" searchType="search" searchName="search" searchPlaceHolder="Search RAM Key / Table / Size" searchId="searchInput" searchValue=""
                                        />
                                    </div>
                                    <div class="col-sm-3">
                                        <span class="flat-box">
                                ...
                                <div class="ram-usage-section">
                                    <div class="table-container">
                                        <div class="table-responsive">
                                            <table class="table" id="romUsageTable">
