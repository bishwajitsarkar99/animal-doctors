...
<!-- ================= Company Branch ================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_branch {{ Request::is('company/branch-activity/branch-*/admin-access/index') || Request::is('company/branch-activity/branch-*/create/index') || Request::is('company/branch-activity/branch-*/user-access/index') ? 'folder-active' : '' }}" role="button" data-bs-toggle="collapse" data-bs-target="#companyBranch" aria-expanded="false" aria-controls="flush-heading">
    <span class="collapsed">
...
<div id="userLog" class="accordion-collapse collapse" aria-labelledby="flush-heading" data-bs-parent="#accordionFlushReport">
    <div class="child-tree">
        <div class="accordion-body sub_box">
            <a type="button" class="nav-link underline nav_space side-bar-link load-page {{ Request::routeIs('user.details') ? 'active' : '' }}" data-url="{{ route('user.redirect') }}" data-url="{{ route('user.redirect') }}" data-bs-toggle="tooltip" data-bs-placement="right" title="<i class='fa-solid fa-plug fa-beat-fade' style='font-size:18px;'>‌</i>" data-bs-delay="100" data-bs-html="true" data-bs-boundary="window" data-bs-template='<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner bg-flora"></div>' >
