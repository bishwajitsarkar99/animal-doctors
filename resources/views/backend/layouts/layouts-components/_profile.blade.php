  ...
  <x-CustomOffCanvas.OffCanvasBody bodyClassName="offcanvas-body">
    <div class="row profile-heading">
      <div class="flex justify-center sm:items-center sm:justify-between mb-3" id="pro_image">
        <span class="image-box profile-img-skeleton">
    ...
    <div class="row">
      <div class="col-xl-12 first_box">
        <div class="company-section profile-head-skeleton" id="company_info">
          <i class="fa-solid fa-layer-group" style="color:#b089ff;">‌</i>
      ...
      <div class="col-xl-12 second_box">
        <div class="company-section profile-head-skeleton" id="personal_info">
          <i class="fa-solid fa-layer-group" style="color:#b089ff;">‌</i>
          <span>Personal Information :</span>
        </div>
        <div class="company-information" style="background: white;">
          <div class="child-box">
            <span id="info" class="image-skeleton">
              <label class="mt-1" for="Contract-number">Contract :</label>
              <span class="mt-1">{{Auth::user()->contract_number}}</span> <br>
            </span>
            <span id="info2" class="image-skeleton">
      ...
      <div class="col-xl-12 third_box">
        <div class="company-section profile-head-skeleton" id="branch_information">
          <i class="fa-solid fa-layer-group" style="color:#b089ff;">‌</i>
      ...
      <div class="col-xl-12 fourth_box">
        <div class="company-section profile-head-skeleton" id="role_info">
          <i class="fa-solid fa-layer-group" style="color:#b089ff;">‌</i>
