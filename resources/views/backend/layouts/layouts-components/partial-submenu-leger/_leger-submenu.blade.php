    ...
    <li>
        <div class="collapse" id="leger_id" aria-labelledby="headingTwo" data-bs-parent="#leger_id">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('day_book_entry_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Day-Book Entry')}}">
                ...
                <a class="nav-link underline" href="{{setting('day_book_view_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Day-Book Details')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('day_book_view_visual')}}">{{__('translate.Entry View-Book')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('day_book_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Day-Book Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
...
<ul class="dropdown-menu dropdown-menu-end tyg rgs line_menu" aria-labelledby="navbarDropdown">
    <li>
        <div class="collapse" id="leger_id" aria-labelledby="headingTwo" data-bs-parent="#leger_id">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('type_of_expenses_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Payment Type')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('type_of_expenses_visual')}}">{{__('translate.Type Of Expenses')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('add_expenses_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Payment Add')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('add_expenses_visual')}}">{{__('translate.ADD Expenses')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('list_expenses_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Payment Details')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('list_expenses_visual')}}">{{__('translate.List Of Expenses')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('setting_expenses_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Payment Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
...
<ul class="dropdown-menu dropdown-menu-end tyg rgs line_menu" aria-labelledby="navbarDropdown">
    <li>
        <div class="collapse" id="leger_id" aria-labelledby="headingTwo" data-bs-parent="#leger_id">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('add_customer_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Customer Add')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('customer_visual')}}">{{__('translate.ADD Customer')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('customer_due_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Customer Due List')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('customer_due_visual')}}">{{__('translate.Customer Due List')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('customer_details_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Customer Payable Record')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('customer_details_visual')}}">{{__('translate.Customer Details Record')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('customer_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Customer Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
...
<ul class="dropdown-menu dropdown-menu-end tyg rgs line_menu" aria-labelledby="navbarDropdown">
    <li>
        <div class="collapse" id="leger_id" aria-labelledby="headingTwo" data-bs-parent="#leger_id">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('add_petty_cash_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Petty Cash Entry Book')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('petty_cash_visual')}}">{{__('translate.Petty Cash Entry')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('all_transaction_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Petty Cash Record')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('all_transaction_visual')}}">{{__('translate.All Transaction')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('petty_cash_details_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Petty Cash Details')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('petty_cash_details_visual')}}">{{__('translate.Petty Cash Details')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('petty_cash_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Petty Cash Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
...
<ul class="dropdown-menu dropdown-menu-end tyg rgs line_menu" aria-labelledby="navbarDropdown">
    <li>
        <div class="collapse" id="leger_id" aria-labelledby="headingTwo" data-bs-parent="#leger_id">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('add_list_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Bank List')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('list_visual')}}">{{__('translate.ADD List')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('bank_transaction_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Banking Transaction')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('bank_transaction_visual')}}">{{__('translate.Bank Transaction')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('details_record_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Bank Details')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('details_record_visual')}}">{{__('translate.Details Record')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('bank_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Transaction Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
...
<ul class="dropdown-menu dropdown-menu-end tyg rgs line_menu" aria-labelledby="navbarDropdown">
    <li>
        <div class="collapse" id="leger_id" aria-labelledby="headingTwo" data-bs-parent="#leger_id">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link underline" href="{{setting('add_tax_vat_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Tax Or VAT Add')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('tax_vat_visual')}}">{{__('translate.ADD Tax/Vat')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('list_vat_tax_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Tax Or VAT List')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('list_vat_tax_visual')}}">{{__('translate.List Of Tax/Vat')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('details_records_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Tax Or VAT Detals Record')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
                    <span class="{{setting('details_records_visual')}}">{{__('translate.Details Record')}}</span>
                </a>
                <a class="nav-link underline" href="{{setting('vat_tax_setting_link')}}" data-bs-toggle="tooltip" data-bs-placement="right" title="{{__('translate.Tax Or VAT Setting')}}">
                    <i class="fa-regular fa-hand-point-right fa-beat me-1"></i>
