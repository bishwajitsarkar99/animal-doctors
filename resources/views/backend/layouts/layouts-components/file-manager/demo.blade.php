<div class="col-2 ms-1 me-1" index="${index}">
    <div class="card form-control form-control-sm file-card mt-2 mb-2">
        <div class="file-area">
            <div class="svg__doted" id="fileSkeltone">
                <svg id="svg_mode" style="width:7em;height:6em;" viewBox="0 0 1024 1024" class="icon popular-svg" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="image-display" id="imageOpen">
                <p>
                    <img src="${imageSrc}" alt="${file}" style="width:50px;height:50px;">
                <div>
                    <a href="${fileLink}" target="_blank"><i class="fa-solid fa-link"></i></a>
                    <button class="btn btn-danger btn-sm delete-file" data-file="${file}"><i class="fa-solid fa-trash-can"></i></button>
                </div>
                </p>
            </div>
        </div>
...
'<div class="col-2 ms-1 me-1">' +
    '<div class="card form-control form-control-sm file-card mt-2 mb-2">' +
        '<div class="file-area">' +
            '<div className="svg__doted" id="fileSkeltone">' +
                '<svg id="svg_mode" style="width:7em;height:6em;" viewBox="0 0 1024 1024" class="icon popular-svg " version="1.1" xmlns="http://www.w3.org/2000/svg">' +
                    '
                    <path d="M878.3 192.9H145.7c-16.5 0-30 13.5-30 30V706c0 16.5 13.5 30 30 30h732.6c16.5 0 30-13.5 30-30V222.9c0-16.5-13.5-30-30-30z" fill="#FFFFFF" />' +
                    '
