<div class="accordion accordion-flush" id="accordionFlushExample">
    <div class="accordion-item {{setting('auth_visual')}}">
        <button class="accordion-button collapsed ath_button" data-bs-toggle="collapse" data-bs-target="#Auth" aria-expanded="false" aria-controls="Auth">
            ...
            <span class="auth__btn">
                <span class="text-animation {{setting('auth_visual')}} {{ Request::is('company/branch-activity/branch-*/admin-access/index') || Request::is('company/branch-activity/branch-*/create/index') || Request::is('company/branch-activity/branch-*/user-access/index') || Request::is('application/user-log/user-log-activity-*/log-dashboard') || Request::is('super-admin/auth-pages/auth-page-permission') || Request::is('super-admin/user-accounts/account-holder/account-history') || Request::is('super-admin/register-emails/email-verification') || Request::is('super-admin/roles/role-index') || Request::is('super-admin/roles/role-permission') || Request::is('super-admin/roles/manage-role') || Request::is('super-admin/users/user-authorization') || Request::is('application/modules/module-category-index') || Request::is('application/modules/module-name-index') || Request::is('application/modules/module-index') ? 'folder-active' : '' }}">{{__('translate.Auth')}}</span>
            </span>
