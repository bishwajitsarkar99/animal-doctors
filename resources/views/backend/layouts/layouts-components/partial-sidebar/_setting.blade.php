<a class="nav-link collapsed lay_nav font_size child_setting" data-bs-toggle="collapse" data-bs-target="#addons" aria-expanded="false" aria-controls="addons">
    ...
    <div class="sb-nav-link-icon">
        <i class="fa-solid fa-gear fa-spin-pulse" style="font-size: 14px;color:white;"></i>
...
<div id="addons" class="accordion-collapse collapse" aria-labelledby="flush-heading" data-bs-parent="#accordionFlushExample">
    <div class="accordion-body sub_box">
        <nav class="sb-sidenav-menu-nested nav child-white-tree">
            <a class="nav-link underline nav_space" style="font-family: sans-serif;color:white;font-size:11px;" data-bs-toggle="tooltip"  data-bs-placement="right" title="{{__('translate.Post-Setting')}}" data-bs-delay="100" data-bs-html="true" data-bs-boundary="window" data-bs-template='<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner bg-flora"></div>' class="underline nav-link collapsed sals_menu compont" href="{{ route('post_setting.index') }}">
                <i class="fa-solid fa-minus" style="color:#ffff;"></i> {{__('translate.Post-Setting')}}
            </a>
            <a class="nav-link underline nav_space" style="font-family: sans-serif;color:white;font-size:11px;" href="{{route('appSetting')}}" data-bs-toggle="tooltip"  data-bs-placement="right" title="{{__('translate.App-Setting')}}" data-bs-delay="100" data-bs-html="true" data-bs-boundary="window" data-bs-template='<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner bg-flora"></div>'>
