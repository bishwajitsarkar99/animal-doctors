<div class="accordion accordion-flush" id="accordionFlushExample">
    <div class="accordion-item {{setting('product_visual')}}">
        <button class="accordion-button collapsed prod_button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
            <a class="nav-link collapsed sals_menu product_link product_btn {{ Request::is('product-components/category') || Request::is('product-components/sub-category') || Request::is('medicine-components/medicine-group') || Request::is('medicine-components/medicine-name') || Request::is('medicine-components/medicine-dosage') || Request::is('product-components/units') || Request::is('product-components/origin') || Request::is('product-components/brand') || Request::is('product-components/model') || Request::is('product-components/product') ? 'folder-active' : '' }}" id="navbar_Dropdown" data-bs-toggle="collapse" data-bs-target="#product" aria-expanded="false" aria-controls="collapsePages">
