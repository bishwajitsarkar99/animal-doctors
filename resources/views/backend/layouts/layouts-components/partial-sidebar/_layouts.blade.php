...
<span class="{{setting('layouts_moduel_display')}}">
    ...
    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
        <nav class="sb-sidenav-menu-nested nav child-white-tree">
            <a class="nav-link underline nav_space" style="font-size: 12px;color:#fff" id="static_nav" data-bs-toggle="tooltip"  data-bs-placement="right" title="File-Manager" data-bs-delay="100" data-bs-html="true" data-bs-boundary="window" data-bs-template='<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner bg-flora"></div>'>
            ...
            <a class="nav-link underline nav_space" style="font-size: 12px;color:#fff" href="#" id="light_mode" data-bs-toggle="tooltip"  data-bs-placement="right" title="Light Sidenav" data-bs-delay="100" data-bs-html="true" data-bs-boundary="window" data-bs-template='<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner bg-flora"></div>'>
