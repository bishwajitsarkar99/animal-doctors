<span class="{{setting('layouts_moduel_display')}}">
    ...
    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
        <nav class="sb-sidenav-menu-nested nav">
            <a class="nav-link underline" style="font-size: 12px;color:#fff" href="#" id="static_nav">Static Nav</a>
            <a class="nav-link underline" style="font-size: 12px;color:#fff" href="#" id="dark_mode">Dark Sidenav</a>
            <a class="nav-link underline" style="font-size: 12px;color:#fff" href="#" id="light_mode">Light Sidenav</a>
        </nav>
    </div>
</span>