<!-- ================== Category ======================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_category {{setting('categ_title_visual')}} {{ Request::is('product-componets/category') ? 'folder-active' : '' }}" id="navbar_Dropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<!-- ================= Sub-Category ================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_sub_category {{setting('sub_categ_title_visual')}} {{Request::is('product-componets/sub-category') ? 'folder-active' : ''}}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="collapsed">
...
<!-- ================= Group ================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_group {{setting('group_title_visual')}} {{Request::is('medicine-components/medicine-group') ? 'folder-active' : '' }}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="collapsed">
...
<!-- =========================== Product ================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_another_product {{setting('product_title_display')}} {{Request::is('product-componets/product') ? 'folder-active' : '' }}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="collapsed">
...
<!-- ================= Prodcut-Model ================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_product_model {{setting('product_model_title_display')}} {{Request::is('product-componets/model') ? 'folder-active' : '' }}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="collapsed">
...
<!-- ============================= Units ==================== -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_unit {{setting('unit_title_display')}} {{Request::is('product-componets/units') ? 'folder-active' : '' }}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="collapsed">
...
<!-- =========================== Brand ================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_brand {{setting('brand_title_display')}} {{Request::is('product-componets/brand') ? 'folder-active' : '' }}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="collapsed">
...
<!-- ================= Medicine ================= -->
<a class="nav-link_cgrMenu dropdown-toggle ty child_product {{setting('medicine_title_visual')}} {{Request::is('medicine-components/medicine-name') || Request::is('medicine-dosage') || Request::is('origin') ? 'folder-active' : '' }}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="collapsed">
