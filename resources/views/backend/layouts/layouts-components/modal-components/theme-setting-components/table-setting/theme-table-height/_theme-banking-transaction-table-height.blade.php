<span id="label_name" class="ps-2">Table-Height :</span>
<select class="theme_menu" id="banktransactionTableHeightSelect">
    <option selected disabled>PX</option>
    ...
    <option value="850px">850px</option>
