<div class="col-md-6">
    <div class="card to_orders mb-2 total_sales mt-2 pb-1 tot_order">
        ...
        <div class="progress_login_header" style="height:0.8rem;">
            <div id="loader" class="progress-bar progress-bar-striped progress-bar-animated bg-light-primary ps-5 ms-3 pb-1 pt-2" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
            </div>
        </div>
    </div>
</div>
<div class="col-md-6">
    <div class="card to_orders mb-2 total_sales mt-2 pb-1 tod_sal">
        ...
        <div class="progress_login_header" style="height:0.8rem;">
            <div id="loader" class="progress-bar progress-bar-striped progress-bar-animated bg-light-primary ps-5 ms-3" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
            </div>
        </div>
    </div>
</div>
