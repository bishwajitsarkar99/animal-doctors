        ...
        <div class="card-body focus-color cd">
            ...
            <div class="detail de">
                <p class="form-check form-switch ord_detl sl">
                    <span>
                        <a type="button" class="form-check-label mt-1 pt-1" for="collapseExample" id="flexSwitchCheckDefault6"><span class=" plantform ords ps-2 pe-2">{{__('translate.Details')}}</span></a>
                    </span>
                </p>
            </div>
        </div>
    ...
    <div class="card to_orders mb-2 mt-1 pb-1 total_sale month_ordr">
        <div class="card-body focus-color cd">
            ...
            <div class="detail de">
                <p class="form-check form-switch ord_detl sl">
                    <span>
                        <a type="button" class="form-check-label mt-1 pt-1" for="collapseExample" id="flexSwitchCheckDefault7"><span class=" plantform ords ps-2 pe-2">{{__('translate.Details')}}</span></a>
                    </span>
                </p>
            </div>
        </div>
    ...
    <div class="card to_orders mb-2 mt-1 pb-1 total_sale exp_ordr">
        <div class="card-body focus-color cd">
            ...
            <div class="detail de">
                <p class="form-check form-switch ord_detl sl">
                    <span>
                        <a type="button" class="form-check-label mt-1 pt-1" for="collapseExample" id="flexSwitchCheckDefault8"><span class=" plantform ords ps-2 pe-2">{{__('translate.Details')}}</span></a>
                    </span>
                </p>
            </div>
        </div>
