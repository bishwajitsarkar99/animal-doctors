<!-- Modal -->
<div class="modal fade" id="sales_details_form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content" id="#">
            <div class="modal-header large_modal_header">
                <h5 class="modal-title admin_title ps-1 pe-1 font-effect-emboss" id="staticBackdropLabel">
                    {{__('translate.Monthly Sales List')}}
                </h5>
                        ...
                        <div class="col-md-12 ps-2">
                            <div class="card-body focus-color cd pb-4">
                                <span class="tol_ord mt-1">
                                    ...
                                    <input id="start_sales_date" type="text" class="select_dateOne large-modal-body" placeholder="DD-MM-YYYY">
                                </span>
