<!-- Modal -->
<div class="modal fade" id="order_details_form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content" id="#">
            <div class="modal-header large_modal_header">
                <h5 class="modal-title admin_title ps-1 pe-1 font-effect-emboss" id="staticBackdropLabel">
                    {{__('translate.Monthly Order List')}}
                </h5>
                        ...
                        <div class="col-md-12 ps-2">
                            <div class="card-body focus-color cd pb-4">
                                <span class="tol_ord mt-1">
                                    ...
                                    <input id="date_id" type="text" class="select_dateOne large-modal-body" placeholder="DD-MM-YYYY">
                                </span>
                                <span class="tol_ord mt-1 ms-2">
                                    <label for="expenses" class="select_labelOne">{{__('translate.End Date')}} :</label>
                                    <input id="date_exid" type="text" class="select_dateOne large-modal-body" placeholder="DD-MM-YYYY">
                                </span>
                                ...
                                <div style="overflow-x:auto;">
                                    <table class="bg-transparent ord_table center border-1 mt-2" id="orderDetailsTable">
                                        ...
                                        <tr class="table-row hover">
                                            ...
                                            <td class="tot_complete_ ps-1">Complete</td>
                                        </tr>
                                        <tr class="table-row hover">
                                            ...
                                            <td class="tot_complete_ ps-1">Reject</td>
                                        </tr>
                                        <tr class="table-row hover">
