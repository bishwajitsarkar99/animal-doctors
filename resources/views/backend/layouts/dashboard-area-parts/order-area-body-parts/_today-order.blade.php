<!-- Modal -->
<div class="modal fade" id="today_order_form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="col-md-12 ps-2">
                            <div class="card-body focus-color cd pt-3 pb-4">
                                ...
                                <div style="overflow-x:auto;">
                                    <table class="bg-tansparent ord_table center border-1 skeleton-children mt-2">
                                        ...
                                        <tr class="table-row hover">
                                            ...
                                            <td class="tot_reject_ ps-1">1,000.00</td>
                                            <td class="tot_reject_ ps-1">1,000.00</td>
                                        ...
                                        <tr class="table-row hover">
                                            ...
                                            <td class="tot_reject_ ps-1">Pics</td>
                                            <td class="tot_reject_ ps-1">1.00</td>
                                            <td class="tot_reject_ ps-1">3,000.00</td>
                                            <td class="tot_reject_ ps-1">3,000.00</td>
                                        ...
                                        <tr class="subtotal_heading">
                                            ...
                                            <td class="ord_subtotal border_ pe-1">4,000.00 <span>৳</span></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
