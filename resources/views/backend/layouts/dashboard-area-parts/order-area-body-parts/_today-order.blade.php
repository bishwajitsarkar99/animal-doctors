...
<div class="modal fade" id="today_order_form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content modal_content_shadow" id="#">
                ...
                <div class="col-xl-12">
                    <div class="row">
                        <div class="col-md-12 ps-2">
                            <div class="card-body focus-color cd pt-2 pb-4">
                                ...
                                <div style="overflow-x:auto;">
                                    <table class="bg-tansparent ord_table center border-1 skeleton-children mt-2">
                                        <tr class="order_body">
                                            ...
                                            <th class="txt ps-1">{{__('translate.Order-ID')}}</th>
                                            <th class="tot_order_ ps-1">{{__('translate.Order Holder Name')}}</th>
                                        ...
                                        <tr class="subtotal_heading">
                                            ...
                                            <td class="ord_subtotal border_ pe-1 ps-1">4,000.00 <span>৳</span></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
