<!-- Modal -->
<div class="modal fade" id="order_pending_form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content" id="#">
            <div class="modal-header large_modal_header">
                <h5 class="modal-title admin_title ps-1 pe-1 font-effect-emboss" id="staticBackdropLabel">
                    {{__('translate.Monthly Pending Order List')}}
                </h5>
                <button type="button" class="btn-close btn-btn-sm" data-bs-dismiss="modal" aria-label="Close" data-bs-toggle="tooltip" data-bs-palacement="right" title="{{__('translate.Close')}}">
                </button>
            </div>
                        ...
                        <div class="col-md-12 ps-2">
                            <div class="card-body focus-color cd pb-4">
                                <span class="tol_ord mt-1">
                                    ...
                                    <input id="start_date" type="text" class="select_dateOne large-modal-body" placeholder="DD-MM-YYYY">
                                </span>
                                <span class="tol_ord mt-1 ms-2">
                                    <label for="expenses" class="select_labelOne">{{__('translate.End Date')}} :</label>
                                    <input id="end_date" type="text" class="select_dateOne large-modal-body" placeholder="DD-MM-YYYY">
                                </span>
                                ...
                                <div style="overflow-x:auto;">
                                    <table class="bg-transparent ord_table center border-1 mt-2" id="orderDetailsTableTwo">
                                        <tr class="table-row order_body">
                                            ...
                                            <th class="txt ord_headLine ps-1">{{__('translate.Order-ID')}}</th>
                                            <th class="tot_order_ ord_headLine ps-1">{{__('translate.Order Holder Name')}}</th>
                                        ...
                                        <tr class="table-row hover">
                                            ...
                                            <td class="txt_ ps-1">ORD-000000</td>
                                            ...
                                            <td class="tot_reject_ ps-1">5,000.00</td>
                                            <td class="tot_reject_ ps-1">5,000.00</td>
                                            <td class="tot_complete_ ps-1">Pending</td>
                                        </tr>
                                        <tr class="table-row hover">
                                            <td class="sn border_ord">2</td>
                                            <td class="txt_ ps-1">5-1-2023</td>
                                            <td class="txt_ ps-1">ORD-000001</td>
                                        ...
                                        <tr class="table-row hover">
                                            ...
                                            <td class="txt_ ps-1">ORD-000003</td>
                                        ...
                                        <tr class="subtotal_heading">
                                            ...
                                            <td class="ord_subtotal border_ pe-1">26,000.00 <span>৳</span></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
