    ...
    <div class="row mb-2">
        <div class="col-xl-8">
            <div class="card form-control form-control-sm mt-1 ps-2 pb-2 pe-2 pt-2 prod_reslt">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <span class="plantform produ skeleton ps-1">
                    ...
                    <div class="col-xl-3 amount-pill">
                        <span class='counter_first badge rounded-pill bg-light-silver skeleton ms-2  iu pe-1' data-val='$row.00'>{{$product_counts}}.00</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4">
                    ...
                    <div class="col-xl-5">
                        <div class="progress_header loadheight skeleton skeleton-children" style="height:0.6em;">
                    ...
                    <div class="col-xl-3 amount-pill">
                        <span class='counter_first badge rounded-pill bg-light-silver skeleton ms-2  iu pe-1' data-val='$row.00'>{{$category_counts}}.00</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4">
                    ...
                    <div class="col-xl-3 amount-pill">
                        <span class='counter_first badge rounded-pill bg-light-silver skeleton ms-2  iu pe-1' data-val='$row.00'>{{$subCategory_counts}}.00</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4">
                    ...
                    <div class="col-xl-3 amount-pill">
                        <span class='counter_first badge rounded-pill bg-light-silver skeleton ms-2  iu pe-1' data-val='$row.00'>{{$brand_counts}}.00</span>
                    </div>
                </div>
            </div>
            <div class="card form-control form-control-sm mt-3 ps-2 pb-2 pe-2 mb-3 prod_reslt">
                <div class="row">
                    ...
                    <div class="col-xl-3 amount-pill">
                        <span class='counter_first badge rounded-pill bg-light-silver skeleton ms-2  iu pe-1' data-val='$row.00'>{{$supplier_counts}}.00</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4">
                    ...
                    <div class="col-xl-3 amount-pill">
                        <span class='counter_first badge rounded-pill bg-light-silver skeleton ms-2  iu pe-1' data-val='$row.00'>{{$vendor_counts}}.00</span>
                    </div>
                </div>
            </div>
        </div>
