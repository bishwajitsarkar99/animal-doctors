<div class="col-xl-6">
    <table class="bg-transparent summary_table skeleton" style="width: 100%;">
        ...
        <tr class="tb_heading skeleton">
            ...
            <td class="tb_body sn_num skeleton capsule-skeleton ps-2" style="font-weight: 700;">{{$total_vendor_counts}}.00</td>
        </tr>
        <tr class="tb_heading skeleton">
            ...
            <td class="tb_body sn_num skeleton capsule-skeleton ps-2" style="font-weight: 700;">{{$active_vendor_counts}}.00</td>
        </tr>
        <tr class="tb_heading skeleton">
            ...
            <td class="tb_body sn_num skeleton capsule-skeleton ps-2" style="font-weight: 700; color:orangered;">{{$inactive_vendor_counts}}.00</td>
        </tr>
    </table>
</div>    