<div class="col-xl-6">
    <table class="bg-transparent summary_table" id="supp_record" style="width: 100%;">
        ...
        <tr class="tb_heading" id="supp_tr2">
            ...
            <td id="supp_td6" class="tb_body sn_num capsule-skeleton ps-2">{{$active_supplier_counts}}.00</td>
        </tr>
        <tr class="tb_heading" id="supp_tr3">
            ...
            <td id="supp_td9" class="tb_body sn_num capsule-skeleton ps-2">{{$active_vendor_counts}}.00</td>
        </tr>
    </table>
</div>