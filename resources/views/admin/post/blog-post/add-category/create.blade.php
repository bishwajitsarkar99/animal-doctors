...
<section class="order-tab">
    ...
    <form action="{{ route('add_category.action') }}" class="mt-2" id="MedicinePostForm" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="row profile-heading">
                        ...
                        <div class="col-md-6">
                            <div class="form-group skeleton mt-3 mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm skeleton" id="post-category" name="category_name" placeholder="{{__('translate.Post Category.........')}}">
                ...
                <div class="col-xl-2">
                    <div class="card card-body side_card">
                        ...
                        <!-- <div class="">
                            ...
                            <input class="stat ms-2 mt-1" type="checkbox" name="navbar_status"><br>
                            <label class="stats" for="status_mode">Status</label>
                            <input class="stat ms-2 mt-1" type="checkbox" name="status">
                        </div> -->
                    </div>
                </div>
            </div>
        ...
        <div class=" profile_modal_footer mt-2 pb-4">
            <button type="submit" class="btn btn-sm modal_button add_btn cate_btn skeleton" id="postAdd">
