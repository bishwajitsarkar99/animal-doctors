...
<section class="order-tab">
    <div class="post-bar-bg-color skeleton">
        <a type="button" style="text-decoration: none;" href="#" class="tablinkcreatepost skeleton ps-2 pe-3" id="user_active">Cateogry</a>
        <a type="button" style="text-decoration: none;" href="#" class="tablinkcreatepost skeleton ps-2 pe-3" id="product_inactive"></a>
        <a type="button" style="text-decoration: none;" href="#" class="tablinkcreatepost skeleton ps-2 pe-3" id="product_inactive"></a>
        <a type="button" style="text-decoration: none;" href="#" class="tablinkcreatepost skeleton ps-2 pe-3" id="product_inactive"></a>
    </div>
    ...
    <div class="card card-body category-post-table table_scroll skeleton mt-4">
        <table class="view-category-table row-border order-column hover skeleton" id="myDataTable" style="width:100%">
            <thead class="skeleton">
                <tr class="skeleton">
                    <th class="skeleton head-font"></th>
                    <th class="skeleton head-font ps-3"></th>
                    <th class="skeleton head-font"></th>
                    <th class="skeleton head-font"></th>
                    <th class="skeleton head-font"></th>
                    <th class="skeleton head-font ps-2"></th>
                    <th class="skeleton head-font ps-2"></th>
                    <th class="skeleton head-font"></th>
                </tr>
            </thead>
