                                                          ...
                                                          <div class="row mt-2">
                                                            <div class="mb-4 d-grid">
                                                                ...
                                                                <span class="input-error-skeleton text-danger name_message show-error remove-error-one">@error('first_name')
                                                                    <span class="space">
                                                                        <span class=""><svg viewBox="0 0 24 24" width="24" height="24" stroke="#999" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><circle cx="12" cy="12" r="4"></circle><line x1="1.05" y1="12" x2="7" y2="12"></line><line x1="17.01" y1="12" x2="22.96" y2="12"></line></svg> </span>
                                                                        {{$message}}@enderror
                                                                    </span>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="col-xl-6">
                                                            ...
                                                            <div class="mb-2 d-grid">
                                                                <div class="align-items-center justify-content-center">
                                                                    ...
                                                                    <a class="btn btn-group-sm upload_btn button-skeleton mt-2" id="uploadButton">
                                                                        <span class="img-upload-icon spinner-border spinner-border-sm register-hidden" style="color:white;opacity:1;width:1em;height:1em;" role="status" aria-hidden="true"></span>
                                                            ...
                                                            <div class="mb-2 d-grid">
                                                                <button type="submit" class="btn btn-group-sm register_btn register_action button-skeleton error_handle" id="reg_submit">
                                                                    <span class="register-icon spinner-border spinner-border-sm" style="color:white;opacity:1;width:1em;height:1em;" role="status" aria-hidden="true" hidden></span>
                                                                    <span class="btn-text">Register</span>
                                                                </button>
                                                            </div>
                                                            <div class="mb-2 d-grid">
                                                                <a type="submit" href="{{$register_form_url}}" class="btn btn-group-sm register_btn register_action button-skeleton" id="back">
                                                                    <span class="back-icon spinner-border spinner-border-sm" style="color:white;opacity:1;width:1em;height:1em;" role="status" aria-hidden="true" hidden></span>
