...
<body>
    <div id="session-modal-content">
        <div class="header">
            <div class="row" style="background-color:white;border-bottom: 1px double lightgray;padding-bottom:15px;">
                <div class="col-6">
                    ...
                    <span style="color:black; font-size:11px; padding-right:5px;float:right;margin-top:10px;">
                        Download :<?php
                        $timezone = date_default_timezone_get();
                        ?>
                        <?php
                ...
                <div class="col-6">
                    @foreach($companyinformations as $infos)
                        <p style="color:black; font-size:12px; text-align:left;margin-left:80px;margin-bottom: 0px;margin-top:10px;">
        ...
        <div class="content">
            ...
            <div class="row">
                <table style="margin-top:5px;">
                    <thead>
                        <tr>
                            <th id="theadLeftBorder" style="text-align:center;width:10px;">SN.</th>
