    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content image_preview">
            <div class="modal-header email_modal_header">
                <h5 class="modal-title img_title text-skeletone" id="imageModalLabel">Image Preview</h5>
                <button type="button" class="btn-close btn-btn-sm img_close text-skeletone" data-bs-dismiss="modal" aria-label="Close"
            ...
            <div class="modal-body">
                <div class="svg__doted svg_skeletone" id="imgSkeltone">
                ...
                <div class="att_image hidden" id="showAttImage">
