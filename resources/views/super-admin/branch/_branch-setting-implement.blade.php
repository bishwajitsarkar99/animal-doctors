<?php 
  ...
  $formGroupButtons = [
    ['formGroupButtonLabel'=>'Cancel','formGroupButtonClass'=>'btn btn-sm danger-repl-btn me-5 skeleton-button', 'formGroupButtonId'=>'cancel_btn', 'formGroupButtonType'=>'reset', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
    ['formGroupButtonLabel'=>'Next','formGroupButtonClass'=>'btn btn-sm success-shadow-btn skeleton-button', 'formGroupButtonId'=>'next', 'formGroupButtonType'=>'button', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
    ['formGroupButtonLabel'=>'Finish','formGroupButtonClass'=>'btn btn-sm success-shadow-btn skeleton-button display_none', 'formGroupButtonId'=>'save', 'formGroupButtonType'=>'button', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>'disabled'],
    ['formGroupButtonLabel'=>'Update','formGroupButtonClass'=>'btn btn-sm success-shadow-btn skeleton-button display_none', 'formGroupButtonId'=>'update_btn', 'formGroupButtonType'=>'reset', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
    ['formGroupButtonLabel'=>'Delete','formGroupButtonClass'=>'btn btn-sm success-shadow-btn display_none', 'formGroupButtonId'=>'deleteBranch', 'formGroupButtonType'=>'button', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
  ];
  $optationGroupBtns = [
    ['label'=>'Enable New Branch', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn', 'enableBtnId'=>'enableNewBranch', 'enableCheck'=>'enableChecking', 'loader'=>'newEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled New Branch', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn', 'enableBtnId'=>'disabledNewBranch', 'enableCheck'=>'disabledChecking', 'loader'=>'newDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Enable Update', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn', 'enableBtnId'=>'enableUpdateBranch', 'enableCheck'=>'enableChecking', 'loader'=>'updateEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled Update', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn', 'enableBtnId'=>'disabledUpdatedBranch', 'enableCheck'=>'disabledChecking', 'loader'=>'updateDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Enable Delete', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn', 'enableBtnId'=>'enableDeleteBranch', 'enableCheck'=>'enableChecking', 'loader'=>'deleteEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled Delete', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn', 'enableBtnId'=>'disabledDeleteBranch', 'enableCheck'=>'disabledChecking', 'loader'=>'deleteDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
  ];

?>
<div>
    <div class="loader-position group-card" drag="true" id="boxLoading" hidden>
        <div class="spinner-border text-success spinner-width" role="status" id="loaderSpin" hidden>
            <span class="visually-hidden"></span>
        </div>
    </div>
    <x-CustomCards.Card cardClass="card custom-card component-focus group-card" drag="true" cardId="settingImplementCard" hiddenAttr="hidden">
            ...
            <x-CustomCards.Card cardClass="card form-control form-control-sm component-focus" cardId="setting_card" hiddenAttr="hidden">
                ...
                <x-CustomCards.CardBodies.CardBody cardBodyClass="card-body focus-color cd branch_form" cardBodyId="table_card_body" hiddenAttr="">
                    ...
                    <x-Forms.Form formClass="" formAutoComplete="off" formId="" >
                        ...
                        <div class="d-flex pe-1 setting_btn_group mt-2">
