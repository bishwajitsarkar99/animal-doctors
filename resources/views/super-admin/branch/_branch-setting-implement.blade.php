<?php 
  ...
  $optationGroupBtns = [
    ['label'=>'Enable New Branch', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn ms-1', 'enableBtnId'=>'enableNewBranch', 'enableCheck'=>'enableChecking', 'loader'=>'newEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled New Branch', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn ms-2 me-1', 'enableBtnId'=>'disabledNewBranch', 'enableCheck'=>'disabledChecking', 'loader'=>'newDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ...
    <x-CustomCards.CardBodies.CardBody cardBodyClass="card-body responsive-card" cardBodyId="" hiddenAttr="">
        ...
        <x-CustomCards.Card cardClass="card form-control form-control-sm component-focus" cardId="setting_card" hiddenAttr="hidden">
            <div id="formMessage" class="card-message-overlay display_none">
                ...
                <span class="ms-1" id="messgText"></span>
            </div>
            <!-- overlay-loader -->
