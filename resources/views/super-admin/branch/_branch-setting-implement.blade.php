<?php 
  ...
  $formGroupButtons = [
    ...
    ['formGroupButtonLabel'=>'Delete','formGroupButtonClass'=>'btn btn-sm purple-btn purple-btn-focus display_none', 'formGroupButtonId'=>'deleteBranch', 'formGroupButtonType'=>'button', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
  ];
  $optationGroupBtns = [
    ...
    ['label'=>'Enable Delete', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'enableDeleteBranch', 'enableCheck'=>'enableChecking', 'loader'=>'deleteEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled Delete', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'disabledDeleteBranch', 'enableCheck'=>'disabledChecking', 'loader'=>'deleteDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
  ];
