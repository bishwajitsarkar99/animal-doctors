<?php 
  $formGroupButtons = [
    ['formGroupButtonLabel'=>'Cancel','formGroupButtonClass'=>'btn btn-sm cgt_cancel_btn btn_focus me-5 skeleton-button', 'formGroupButtonId'=>'branch_type_cancel', 'formGroupButtonType'=>'reset', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
    ['formGroupButtonLabel'=>'Create','formGroupButtonClass'=>'btn btn-sm purple-btn purple-btn-focus skeleton-button', 'formGroupButtonId'=>'branch_type_create', 'formGroupButtonType'=>'button', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
    ['formGroupButtonLabel'=>'Update','formGroupButtonClass'=>'btn btn-sm purple-btn purple-btn-focus skeleton-button display_none', 'formGroupButtonId'=>'branch_type_update', 'formGroupButtonType'=>'reset', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
    ['formGroupButtonLabel'=>'Delete','formGroupButtonClass'=>'btn btn-sm purple-btn purple-btn-focus display_none', 'formGroupButtonId'=>'branch_type_delete', 'formGroupButtonType'=>'button', 'formGroupButtonSpinerText'=>'', 'groupIconClass'=>'', 'disabledAttribute'=>''],
  ];
  $optationGroupBtns = [
    ['label'=>'Enable Category', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'enableCategoryBranch', 'enableCheck'=>'enableChecking', 'loader'=>'newEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled Category', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'disabledCategoryBranch', 'enableCheck'=>'disabledChecking', 'loader'=>'newDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Enable Update', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'enableUpdateCategory', 'enableCheck'=>'enableChecking', 'loader'=>'updateEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled Update', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'disabledUpdatedCategory', 'enableCheck'=>'disabledChecking', 'loader'=>'updateDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Enable Delete', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'enableDeleteCategory', 'enableCheck'=>'enableChecking', 'loader'=>'deleteEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled Delete', 'btnType'=>'button', 'btnClass'=>'btn btn-sm purple-btn purple-btn-shadow', 'enableBtnId'=>'disabledDeleteCategory', 'enableCheck'=>'disabledChecking', 'loader'=>'deleteDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
  ];
...
<x-CustomCards.Card cardClass="card custom-card component-focus" cardId="settingCard" hiddenAttr="hidden">
