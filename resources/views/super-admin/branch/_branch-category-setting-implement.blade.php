<?php 
  ...
  $optationGroupBtns = [
    ['label'=>'Enable', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn', 'enableBtnId'=>'enableCategoryBranch', 'enableCheck'=>'enableChecking', 'loader'=>'newEnableLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
    ['label'=>'Disabled', 'btnType'=>'button', 'btnClass'=>'btn btn-sm success-shadow-btn ms-2', 'enableBtnId'=>'disabledCategoryBranch', 'enableCheck'=>'disabledChecking', 'loader'=>'newDisabledLoader', 'hiddenAttributeBtn'=>'hidden', 'hiddenAttributeLoader'=>'hidden', 'hiddenAttributeCheckMark'=>'hidden'],
