<?php 
  ...
  $commonMenuBtns = [
    ...
    ['commonBtnId'=> 'tableResize', 'menuBtnLable'=> 'Reset Table Resize']
  ];
?>
                  ...
                  <div class="col-12">
                    <ul class="menu-btn-group">
                      ...
                      <li class="line-row dropdown-search-submenu-component-wrapper">
                        <x-Buttons.MenuButtons.MenuCardButton className="menu-btn" menuBtnId="searchMenu">
                        ...
                        <x-MenuCards.SubMenuCards.SubMenuCard subMenuCardClass="dropdown-search-sunmenu-component submenu-card">
                      ...
                      <li class="line-row dropdown-filter-submenu-component-wrapper">
                        <x-Buttons.MenuButtons.MenuCardButton className="menu-btn" menuBtnId="filterMenu">
                        ...
                        <x-MenuCards.SubMenuCards.SubMenuCard subMenuCardClass="dropdown-filter-submenu-component submenu-card">
                          ...
                          <li class="child-line-row">
                            <x-Buttons.MenuButtons.SubMenuCardButton subMenuBtnId="{{ $data['filterBtnId'] }}">
                      ...
                      <li class="line-row dropdown-download-submenu-component-wrapper">
                        <x-Buttons.MenuButtons.MenuCardButton className="menu-btn" menuBtnId="downloadMenu">
                        ...
                        <x-MenuCards.SubMenuCards.SubMenuCard subMenuCardClass="dropdown-download-submenu-component submenu-card">
                          ...
                          <li class="child-line-row">
                            <x-Buttons.MenuButtons.SubMenuCardButton subMenuBtnId="{{ $data['downloadBtnId'] }}">
                              <svg width="18" height="20" viewBox="0 0 24 24" fill="none" stroke="dodgerblue" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-link-2">
                                <path d="M15 7h3a5 5 0 0 1 5 5 5 5 0 0 1-5 5h-3m-6 0H6a5 5 0 0 1-5-5 5 5 0 0 1 5-5h3"/>
                                <line x1="8" y1="12" x2="16" y2="12"/>
                              </svg>
                      ...
                      <li class="line-row">
                        <x-Buttons.MenuButtons.MenuCardButton className="menu-btn" menuBtnId="{{ $data['commonBtnId'] }}">
