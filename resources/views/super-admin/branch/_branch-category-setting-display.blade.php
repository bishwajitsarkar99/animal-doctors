<div>
    <div class="loader-position" id="startLoading" hidden>
        <div class="spinner-border text-success spinner-width" role="status" id="continueousLoading" hidden>
            <span class="visually-hidden"></span>
        </div>
    </div>
    <x-CustomCards.Card cardClass="card custom-card component-focus group-card" drag="true" cardId="categorySettingDisplayCard" hiddenAttr="hidden">
        <x-CustomCards.CardHeaders.CardHeader cardHeaderClass="card-header custom-header" cardHeaderId="" hiddenAttr="">
            ...
            Display Branch Category Settings
        ...
        <x-CustomCards.CardBodies.CardBody cardBodyClass="card-body" cardBodyId="" hiddenAttr="">
            <x-UlListMenus.UlListMenu ulClassName="optation-box" ulPaddingClassName="" ulId="">
                <x-UlListMenus.UlListMenu ulClassName="setting-display" ulPaddingClassName="optation-padding" ulId="categorySettingDisplay" >
