        ...
        <div class="modal-content" id="admin_modal_box">
            ...
            <form id="userUpdateForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row profile-heading pb-3">
                        <div class="col-xl-8">
                            <div class="form-group" id="editusr">
                                ...
                                <input type="text" class="mt-3 user_id_field id" id="edit_user_id" readonly>
                            </div>
                            <div class="form-group" id="editusr6">
                                <label class="label_user_edit" for="name" id="editusr3">Name :</label>
                                <input id="edit_user_name" class="mt-3 ps-1 update_user usersearch name" type="text" name="name" placeholder="Enter name">
                                <i class="uname-icon fa fa-spinner fa-spin uname-hidden"></i>
                            </div>
                            <div class="form-group" id="editusr7">
                                <label class="label_user_edit" for="email" id="editusr4">Email :</label>
                                <input id="edit_user_email" class="mt-3 ps-1 update_email email useremailsearch" type="text" name="email" placeholder="Enter Email Address">
                                <i class="uemail-icon fa fa-spinner fa-spin uemail-hidden"></i>
                            </div>
                            <div class="form-group" id="editusr8">
                                <label class="label_user_edit" for="contract_number" id="editusr5">Contract-Number : </label>
                                <input id="edit_user_contract" class="mt-3 ps-1 update_contract contract_number usercontractsearch" type="text" name="contract_number" placeholder="Enter contract number">
                ...
                <div class="modal-footer profile_modal_footer">
                    <button href="#" type="button" class="btn btn-sm modal_button update_btn btn_focus" id="userUpdate">
                        <i class="updated-icon fa fa-spinner fa-spin updated-hidden"></i>
                        <span class="btn-text">Update</span>
                    </button>
                    <button type="button" class="btn btn-sm text-danger modal_button cancel_btn btn_focus" id="editusr9" data-bs-dismiss="modal">Cancel</button>
                </div>
            </form>
        </div>
    </div>
