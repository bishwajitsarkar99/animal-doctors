<script type="module">
    ...
    $(document).ready(() => {
                ...
                return `
                    <tr>
                        <td class="error_data" align="center" text-danger colspan="11">
                            ...
                            Search product data not exists on server <span style="color:rgb(220, 53, 69)">!</span>
                        </td>
                    </tr>
                `;
            }
            ...
            return [...rows].map((row, key) => {
                ...
                return `
                    <tr class="table-row user-table-row" id="prod" key="${key}">
                        ...
                        <td class="tot_complete_ center line_height_three" id="prod5">
        ...
        function fetch_product_data(
            ...
            perItem = null, 
            sortFieldID = 'id', 
            sortFieldProductName = 'product_name',
            ...
            $.ajax({
                ...
                data: {
                    ...
                    sort_field_product_name : sortFieldProductName,
                ...
                success: function({
                    ...
                    $("#total_items").text(total_product);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        productID.append(`<label class="label_user_edit"> Product-ID : <span class="word_space">${response.messages.id}</span></label>`);
                        productName.append(`<label class="label_user_edit"> Product-Name : <span class="word_space">${response.messages.product_name}</span></label>`);
                    }
                }
            });
        });
        ...
        $(document).on('click', '#update_btn', function(e){
            ...
            $("#productID").addClass('skeleton');
            $("#productName").addClass('skeleton');
            ...
            time = setTimeout(() => {
                ...
                $("#productID").removeClass('skeleton');
                $("#productName").removeClass('skeleton');
                ...
                success: function(response) {
                    if (response.status == 400) {
                        $.each(response.errors, function(key, err_value) {
                            ...
                            $('#product_name').removeClass('display-none');
                            $("#product_name").addClass('is-invalid');
                            $('#updateForm_errorList').addClass('alert_show_errors');
                        ...
                        setTimeout(() => {
                            ...
                            $(".edit_product_name").removeClass('is-valid');
                            $("#save").show('slow');
                            $("#update_btn").attr('hidden', true);
                            $("#update_btn").hide('slow');
                            setTimeout(() => {
        ...
        $(document).on('click', '#th_sort', function(){
            ...
            fetch_product_data(
                '', null, null,
                column === 'id' ? column : 'id',
                column === 'product_name' ? column : 'product_name',
