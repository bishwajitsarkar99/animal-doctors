    ...
    <div class="row">
      <div class="col-xl-7">
        <div class="card-body focus-color cd cat_form">
          <p class="catg mb-2">
            <span class="">{{__('translate.Origin')}}</span>
            <span class="tot_summ" id="num_plate">
              <label class="tot-search mt-3 pt-1" for="tot_cagt"> ➤ {{__('translate.Total Origin')}} :</label>
              <label class="badge pill-rounded skeleton-head-capsule" for="total_medic_records" id="iteam_label4" style="font-size: 12px;"><span class="total_users" style="font-weight: 700;" id="total_origin_records"></span><span id="iteam_label5" style="font-weight: 700;color:black;">.00</span></label>
            </span>
          ...
          <div class="table-responsive">
            <table class="table-light center border-1 mt-2">
              <thead class="table-light table-fixed table-light">
                <tr class="table-light table-row order_body acc_setting_table">
                  ...
                  <th id="th_sort" data-coloumn="id" data-order="desc" class="tableHead table_th_color tot_pending_ col" style="text-align: left;cursor: pointer;">
                    {{__('translate.Origin-Name')}}
                    <svg width="12px" height="12px" fill="#333333a1" version="1.1" id="Layer_1" x="0px" y="0px" width="122.433px" height="122.88px" viewBox="0 0 122.433 122.88" enable-background="new 0 0 122.433 122.88" xml:space="preserve"><g><polygon fill-rule="evenodd" clip-rule="evenodd" points="61.216,0 0,63.673 39.403,63.673 39.403,122.88 83.033,122.88 83.033,63.673 122.433,63.673 61.216,0"/></g></svg>
                  </th>
                  <th id="th_sort" data-coloumn="id" data-order="desc" class="tableHead table_th_color tot_pending_ " style="cursor: pointer;">
                    {{__('translate.Status')}}
                    <svg width="12px" height="12px" fill="#333333a1" version="1.1" id="Layer_1" x="0px" y="0px" width="122.433px" height="122.88px" viewBox="0 0 122.433 122.88" enable-background="new 0 0 122.433 122.88" xml:space="preserve"><g><polygon fill-rule="evenodd" clip-rule="evenodd" points="61.216,0 0,63.673 39.403,63.673 39.403,122.88 83.033,122.88 83.033,63.673 122.433,63.673 61.216,0"/></g></svg>
                  </th>
                  <th id="th_sort" data-coloumn="id" data-order="desc" class="tableHead table_th_color tot_pending_ col" style="cursor: pointer;">
              ...
              <tbody class="table-light bg-white skeleton" id="origin_data_table"></tbody>
            </table>
          </div>
          <div class="row table-light">
            ...
            <div class="col-xl-10">
              <div class="pagination pagination-skeleton" id="origin_data_table_paginate"></div>
            </div>
          </div>
          <div class="row">
            <div class="col-xl-12">
                ...
                <div class="row mt-3">
                  <div class="col-12">
                    <div class="input-group">
                      <input class="form-control form-control-sm edit_origin_name" type="text" name="origin_name" id="origin_name" placeholder="" autofocus>
                      <label for="origin-name">{{__('translate.Origin Name')}}</label>
...
{{-- Start Delete Origin Modal--}}
<!-- Modal -->
<div class="modal fade" id="deleteorigin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="admin_modal_box">
        ...
        <div class="row profile-heading pb-3">
          <div class="col-xl-122">
            <div class="form-group delete_content">
              <label class="label_user_edit" id="origin_delt2" for="id">{{__('translate.Unit-ID')}} : </label>
              <span id="origin_delt"><input type="text" class="mt-3 update_id id" id="delete_origin_id" readonly></span><br>
              <span class="label_user_edit" id="origin_delt3">{{__('translate.Are you sure, Would you like to delete this origin, permanently?')}}</span>
              <input type="hidden" id="delete_origin_id" name="origin_id">
      ...
      <div class="modal-footer profile_modal_footer btn_box">
        <p id="btn_group2">
          <p id="btn_group2">
...
{{-- Start Confirm Delete Origin Modal--}}
<!-- Modal -->
      ...
      <div class="modal-header" id="logoutModal_header">
        ...
        <div class="modal-body" id="logoutModal_body">
          <p class="admin_paragraph" style="text-align:center;" id="text_message">
            <label class="label_user_edit" id="cate_confirm" for="id">Are you confirm, to delete about the origin ? </label>
          </p>
        ...
        <div class="modal-footer btn_box" id="logoutModal_footer">
          <button type="button" class="btn btn-sm cgt_cancel_btn btn_focus" id="origin_delt4" data-bs-dismiss="modal">Cancel</button>
          <button href="#" type="button" class="btn btn-sm cgt_btn btn_focus delet_btn_user" id="confirmDelete">
...
{{-- End Confirm Delete Origin Modal--}}

{{-- Start Confirm Update origin Modal--}}
<!-- Modal -->
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content small_modal" style="border:none;" id="admin_modal_box">
      <div class="modal-header" id="logoutModal_header">
        ...
        <div class="modal-body" id="logoutModal_body">
          <span id="originID"></span><br>
          <span id="originName"></span><br>
...
{{-- End Confirm Update origin Modal--}}

@endsection
@section('css')
<link rel="stylesheet" href="{{asset('backend_asset')}}/support_asset/product-item/category/category.css">
<link rel="stylesheet" href="{{asset('backend_asset')}}/support_asset/product-item/origin/origin.css">
...
@include('super-admin.product-components.origin.data-handel-ajax.data-ajax')
...
<script>
  ...
  function focuCardHeadCapsule() {
    const allSkeleton = document.querySelectorAll('.skeleton-head-capsule')

    allSkeleton.forEach(item => {
      item.classList.remove('skeleton-head-capsule')
    });
  }
