                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="progress mt-2" style="height:0.8rem;">
                            <div class="progress-bar progress-bar-striped bg-login progress-bar-animated" role="progressbar" style="width: 50%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                50%
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2">
                        <label class="badge rounded-pill bg-primary" for="total_medic_records " id="iteam_label4" style="font-size: 11px;">
                            <span class="total_users " style="font-weight: 600;color:white;" id="total_activites_records"></span>
