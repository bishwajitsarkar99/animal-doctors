        ...
        <div class="card-body focus-color cd branch_form">
            <div class="row">
                <div style="justify-content:center;align-items:center;display:flex;">
                    @auth
                        <h4 class="display-6 text-bold top-skeleton" style="color:#555;font-size: 1.1vw;font-weight: 700;font-family: 'Poppins', Sans-serif;">
                            ...
                            The {{$user_activity_page_name}} data table connection is not available !
                        </h4>
                    @endauth
                </div>
                <div class="col-xl-5">
                ...
                <div class="col-xl-4 text-bold-skeletone" style="text-align:center;align-items:center;">
                    @auth
                        <img class="" style="width:300px;height:300px;margin-top: -10px;" src="/image/data-stracture.png" alt="error-image">
                    @endauth
                </div>
                <div class="col-xl-3" style="text-align:center;">
                    @auth
                        <h1 class="mt-4  display-1 fw-6 px-4 text-lg text-gray-500 border-r border-gray-400 tracking-wider error-code code-skeletone">409</h1>
