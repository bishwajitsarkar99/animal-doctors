...
<div class="row mt-3">
    <div class="col-xl-6">
        <div class="card card-body five-card">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <span class="login-user-title">Admin Users</span>
                </div>
                <div class="col-xl-6">
                    <div class="progress mt-2" style="height:0.8rem;">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <span class="login-user-title">Sub-Admin Users</span>
                </div>
                <div class="col-xl-6">
                    <div class="progress mt-2" style="height:0.8rem;">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <span class="login-user-title">Accounts Users</span>
                </div>
                <div class="col-xl-6">
                    <div class="progress mt-2" style="height:0.8rem;">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <span class="login-user-title">General Users</span>
                </div>
                <div class="col-xl-6">
                    <div class="progress mt-2" style="height:0.8rem;">
