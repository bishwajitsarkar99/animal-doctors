...
@include('backend.layouts.dashboard-components._navbar')
        ...
        <div class="modal-body center-modal-content" id="SM_Modal_body">
          <div class="row mb-2">
            ...
            <div class="col-xl-3">
              <div class="download-tab">
                <span class="download-group-btn">
                  <a class="download-link-btn" id="exportExcel">
  ...
  <!-- Print Preview Modal Structure #logSessionPrintModal-->
  <!-- <div class="modal fade" id="#" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel">
