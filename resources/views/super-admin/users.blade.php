          ...
          <div class="card-body focus-color user_details cd">
            ...
            <div class="mt-2">
              <table class="ord_table center border-1 mt-1 skeleton">
                <tr class="table-row order_body acc_setting_table skeleton">
                  ...
                  <th id="th_sort" class="table_th_color tot_pending_ col  skeleton">Status</th>
                </tr>
            ...
            <div class="row table_last_row">
                <div class="col-2">
                  ...
                  <select class="mt-3" id="perItemControl">
  ...
  <div class="modal-dialog">
    <div class="modal-content" id="admin_modal_box">
      ...
      <div class="modal-footer profile_modal_footer">
        ...
        <button type="button" class="btn btn-sm modal_button delete_cancel btn_focus" id="usrdelt4" style="color: orangered;" data-bs-dismiss="modal">Cancel</button>
      </div>
    </div>
  </div>
</div>
