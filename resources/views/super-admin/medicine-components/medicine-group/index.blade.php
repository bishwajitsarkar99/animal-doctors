                ...
                <div class="row mt-3">
                  <div class="col-12">
                    <div class="input-group">
                      <input class="form-control form-control-sm edit_group_name" type="text" name="group_name" id="group_name" placeholder="" autofocus>
                      <label for="group-name">{{__('translate.Group Name')}}</label>
...
@include('super-admin.medicine-components.medicine-group.data-handel-ajax.data-handel-ajax')
<script>
  // skeleton
  function fetchData() {
