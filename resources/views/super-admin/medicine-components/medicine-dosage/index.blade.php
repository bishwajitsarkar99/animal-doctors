              ...
              <p class="catg mb-2">
                ...
                <span class="tot_summ" id="num_plate">
                  ...
                  <label class="badge pill-rounded skeleton-head-capsule" for="total_medicinedogs_records" id="iteam_label4">
                    ...
                    <span style="font-weight: 700;color:black;font-size: 11px;">.00 {{__('translate.dosage')}}</span>
                  </label>
                </span>
                ...
                <div class="row mt-3">
                  <div class="col-12">
                    <div class="input-group">
                      <input class="form-control form-control-sm edit_medicine_dogs" type="text" name="dosage" id="medicine_dogs" placeholder="" autofocus>
                      <label for="medicine-dosage">{{__('translate.Medicine Dosage')}}</label>
        ...
        <div class="row profile-heading pb-3">
          <div class="col-xl-12">
            <div class="form-group delete_content">
              ...
              <span id="dosage"><input type="text" class="mt-3 update_id id" id="delete_medicine_dogs_id" readonly></span><br>
              <p class="label_user_edit" id="dosage3">{{__('translate.Are you sure, Would you like to delete this medicine dosage, permanently?')}}</p>
    ...
    <div class="modal-content small_modal" style="border:none;" id="admin_modal_box">
      <div class="modal-header" id="logoutModal_header">
        ...
        <div class="modal-footer btn_box" id="logoutModal_footer">
          <button type="button" class="btn btn-sm cgt_cancel_btn btn_focus" id="dosage4" data-bs-dismiss="modal">Cancel</button>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content small_modal" style="border:none;" id="admin_modal_box">
      <div class="modal-header" id="logoutModal_header">
        ...
        <div class="modal-body" id="logoutModal_body">
          <span id="medicinedosageID"></span><br>
          <span id="medicinesID"></span><br>
          <span id="medicineDosage"></span><br>
...
@include('super-admin.medicine-components.medicine-dosage.data-handel-ajax.data-ajax')
