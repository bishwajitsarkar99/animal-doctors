                ...
                <div class="row profile-heading pb-3">
                    <div class="col-xl-12 delete_content" id="postDelt">
                        ...
                        <div class="form-group">
                            <label class="label_user_edit" for="id" id="postDelt2">{{__('translate.Post-ID')}} : </label>
                            <input type="text" class="mt-3 update_id id" id="delete_main_post_id" readonly><br>
                            <span class="label_user_edit" id="postDelt3">{{__('translate.Are you sure, Would you like to delete this post, permanently?')}}</span>
                            <input type="hidden" id="delete_main_post_id" name="main_post_id">
                        </div>
                    </div>
                </div>
            </div>
