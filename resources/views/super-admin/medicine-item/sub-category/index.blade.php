        ...
        <div class="card-body focus-color cd cat_form">
          ...
          <div class="row">
            ...
            <div class="col-2 link">
              <button class="btn btn-sm cgt_btn btn_focus" href="#" type="button" id="showCategory">{{__('translate.Category')}}</button>
            </div>
          </div>
          <div>
            ...
            <div class="card form-control cat_form">
              <form autocomplete="off">
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-6">
                    <span class="skeleton"><input class="form-control form-control-sm edit_category_id" type="number" name="category_id" id="category_id" list="datalistOptions1" placeholder="{{__('translate.Category ID')}}" required></span>
            ...
            <div class="row">
              <div class="col-6">
                <span class="form-check form-switch search_ me-2">
                  ...
                  <label class="form-check-label skeleton" for="collapseExample"><span class="search_on skeleton" id="search_off_" style="color: darkcyan;font-weight:600;font-size: 10px;">OFF</span><span class="search_on skeleton" id="search_on_" style="color: darkcyan;font-weight:600;font-size: 10px;">ON</span></label>
                </span>
              </div>
              <div class="col-6">
                <span id="search_plate">
