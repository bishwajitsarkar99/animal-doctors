<script>
    $(document).ready(() => {
        ...
        // Fetch Model Data ------------------
        function fetch_product_get_data(query = '', url = null, perItem = null, sortFieldID = 'id', sortFieldDirection = 'desc',) {
        ...
        $(document).on('click', '#search_area_', function() {
            ...
            if ($(this).prop('checked')) {
                $("#prod_search").removeAttr('hidden').focus();
                $("#search_on_").removeAttr('hidden');
                $("#search_off_").hide();
            } else {
                $("#prod_search").attr('hidden', true);
        ...
        $(document).on('click', '.sortable-header', function() {
            ...
            fetch_product_get_data('', null, null, column, order);
