    ...
    <div class="row">
      <div class="col-xl-7">
        <div class="card-body focus-color cd cat_form">
          <p class="catg mb-2">
            <span class="">{{__('translate.Units')}}</span>
            <span class="tot_summ" id="num_plate">
              <label class="tot-search mt-3" for="tot_cagt"> ➤ {{__('translate.Total Unit')}} :</label>
              <label class="badge pill-rounded skeleton-head-capsule" for="total_medic_records" id="iteam_label4"><span class="total_users" style="font-weight: 700;" id="total_units_records"></span><span id="iteam_label5" style="font-weight: 700;color:black;">.00</span></label>
            </span>
            ...
            <table class="table-light center border-1 mt-2">
              <thead class="table-fixed table-light">
                <tr class="table-light table-row order_body acc_setting_table">
                  ...
                  <th id="th_sort" data-coloumn="units_name" data-order="desc" class="tableHead table_th_color tot_pending_ col" style="text-align: left;cursor: pointer;">
                   {{__('translate.Unit-Name')}}
                   <svg width="12px" height="12px" fill="#333333a1" version="1.1" id="Layer_1" x="0px" y="0px" width="122.433px" height="122.88px" viewBox="0 0 122.433 122.88" enable-background="new 0 0 122.433 122.88" xml:space="preserve"><g><polygon fill-rule="evenodd" clip-rule="evenodd" points="61.216,0 0,63.673 39.403,63.673 39.403,122.88 83.033,122.88 83.033,63.673 122.433,63.673 61.216,0"/></g></svg>
                  </th>
              ...
              <tbody class="table-light bg-white skeleton" id="units_data_table"></tbody>
            </table>
          </div>
          <div class="row table-light">
            ...
            <div class="col-xl-10">
              <div class="pagination pagination-skeleton" id="units_data_table_paginate">
...
{{-- Start Delete Units Modal--}}
<!-- Modal -->
<div class="modal fade" id="deleteunits" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="row profile-heading pb-3">
          <div class="col-xl-12">
            <div class="form-group delete_content">
              <label class="label_user_edit" id="unit_delt2" for="id">{{__('translate.Unit-ID')}} : </label>
              <span id="unit_delt"><input type="text" class="mt-3 update_id id" id="delete_unit_id" readonly></span><br>
              <span class="label_user_edit" id="unit_delt3">{{__('translate.Are you sure, Would you like to delete this unit, permanently?')}}</span>
...
{{-- End EDelete Units Modal---}}

{{-- Start Confirm Delete Units Modal--}}
<!-- Modal -->
<div class="modal fade" id="deleteconfirmunits" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content small_modal" style="border:none;" id="admin_modal_box">
      <div class="modal-header" id="logoutModal_header">
        <h6 class="modal-title admin_title scan confirm_title pt-1 me-1" id="staticBackdropLabel">
          Confirm Delete
        </h6>
        ...
        <div class="modal-body" id="logoutModal_body">
          <p class="admin_paragraph" style="text-align:center;" id="text_message">
            <label class="label_user_edit" id="cate_confirm" for="id">Are you confirm, to delete about the unit ? </label>
          </p>
        ...
        <div class="modal-footer btn_box" id="logoutModal_footer">
          <button type="button" class="btn btn-sm cgt_cancel_btn btn_focus" id="unit_delt4" data-bs-dismiss="modal">Cancel</button>
...
<!-- Modal -->
<div class="modal fade" id="updateconfirmunits" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content small_modal" style="border:none;" id="admin_modal_box">
      <div class="modal-header" id="logoutModal_header">
        ...
        <div class="modal-body" id="logoutModal_body">
          <span id="unitsID"></span><br>
          <span id="unitsName"></span><br>
...
<link rel="stylesheet" href="{{asset('backend_asset')}}/support_asset/product-item/units/units.css">
