<script type="module">
    ...
    $(document).ready(() => {
                ...
                return `
                    <tr>
                        <td class="error_data" align="center" text-danger colspan="11">
                            ...
                            Search origin data not exists on server <span style="color:rgb(220, 53, 69)">!</span>
                        </td>
                    </tr>
                `;
            }
            ...
            return [...rows].map((row, key) => {
                ...
                return `
                    <tr class="table-row user-table-row" id="origin_tab" key="${key}">
                        ...
                        <td class="txt_ center" id="origin_tab3">
                            <div class="dropdown">
                        ...
                        <td class="tot_complete_ center line_height_three" id="origin_tab5">
        ...
        $(document).on('click', '#cancel_btn', () => {
            ...
            $('.edit_origin_name').removeClass("is-valid");
            $('.edit_origin_name').removeClass("is-invalid");
        });
                ...
                success: function(response) {
                    if (response.status == 400) {
                        ...
                        setTimeout(() => {
                            ...
                            $('#origin_name').val("");
                            $('#origin_name').removeClass('is-valid');
                            setTimeout(() => {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        originID.append(`<label class="label_user_edit"> Product Origin-ID : <span class="word_space">${response.messages.id}</span></label>`);
                        originName.append(`<label class="label_user_edit"> Product Origin-Name : <span class="word_space">${response.messages.origin_name}</span></label>`);
                    }
                }
            });
        });
        ...
        $(document).on('click', '#update_btn', function(e){
            ...
            $("#originID").addClass('skeleton');
            $("#originName").addClass('skeleton');
            ...
            time = setTimeout(() => {
                ...
                $("#originID").removeClass('skeleton');
                $("#originName").removeClass('skeleton');
