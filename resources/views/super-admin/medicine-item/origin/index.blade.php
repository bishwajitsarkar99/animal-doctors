          ...
          <div class="category-form">
            <div class="card form-control cat_form">
              <form class="mini-form" autocomplete="off">
                ...
                <div class="row mt-3">
                  <div class="col-12">
                    <input class="form-control form-control-sm edit_origin_name" type="text" name="origin_name" id="origin_name" placeholder="{{__('translate.Origin Name')}}" autofocus>
...
@include('super-admin.medicine-item.origin.data-handel-ajax.data-ajax')
