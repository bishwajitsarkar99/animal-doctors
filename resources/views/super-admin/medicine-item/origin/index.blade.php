    ...
    <div class="row">
      <div class="col-xl-7">
        <div class="card-body focus-color cd cat_form">
          <p class="catg mb-1">
            <span class="skeleton-card-head-two">{{__('translate.Origin')}}</span>
            <span class="tot_summ" id="num_plate">
              <label class="tot-search skeleton-card-head-labl mt-3 pt-1" for="tot_cagt"> ➤ {{__('translate.Total Origin')}} :</label>
              <label class="badge rounded-pill bg-primary skeleton-card-head-capsule-two" for="total_medic_records" id="iteam_label4" style="font-size: 11px;"><span class="total_users" style="font-weight: 600;" id="total_origin_records"></span><span id="iteam_label5" style="font-weight: 600;color:white;">.00</span></label>
            </span>
          ...
          <div class="table-responsive">
            <table class="ord_table center border-1 skeleton mt-2">
              <tr class="table-row order_body acc_setting_table skeleton">
                ...
                <th id="th_sort" data-coloumn="id" data-order="desc" class="tableHead table_th_color tot_pending_ col skeleton ps-1" style="text-align: left;cursor: pointer;"><i class="toggle-icon fa-solid fa-arrow-up-long"></i> {{__('translate.Origin-Name')}}</th>
          ...
          <div class="row table_last_row">
            ...
            <div class="col-10">
              <div class="pagination pagination-skeleton mt-1" id="origin_data_table_paginate">
              ...
              <form autocomplete="off">
                ...
                <div class="row mt-3">
                  <div class="col-5 skeleton-input-label">
                    <label class="catg_name_label mt-1" for="origin-name">{{__('translate.Origin-Name')}} :</label>
                  </div>
                  <div class="col-1">
      ...
      <div class="modal-body profile-body pb-1">
        ...
        <div class="row profile-heading pb-3">
          <div class="col-xl-122">
            <div class="form-group delete_content" id="origin_delt">
              ...
              <input type="text" class="mt-3 update_id id" id="delete_origin_id" readonly><br>
