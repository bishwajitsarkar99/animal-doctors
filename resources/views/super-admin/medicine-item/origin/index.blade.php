      ...
      <div class="col-xl-7">
        <div class="card-body focus-color cd cat_form">
          ...
          <div class="row table_last_row">
            ...
            <div class="col-10">
              <div class="pagination skeleton mt-1" id="origin_data_table_paginate">
          ...
          <div class="category-form">
            <div class="card form-control cat_form skeleton">
              <form autocomplete="off">
                ...
                <div class="row mt-3">
                  <div class="col-5">
                    <label class="catg_name_label skeleton mt-1" for="origin-name">{{__('translate.Origin-Name')}} :</label>
                  </div>
                  <div class="col-1">
