          ...
          <p class="catg skeleton mb-1">
            ...
            <span class="tot_summ skeleton" id="num_plate">
              ...
              <label class="badge rounded-pill bg-primary" for="total_medic_records" id="iteam_label4">
                ...
                <span id="iteam_label5" style="font-weight:600;color:white;font-size:11px;font-family: sans-serif;">.00 {{__('translate.items')}}</span>
              </label>
            </span>
          </p>
          <div class="row">
          ...
          <div>
            <table class="ord_table center border-1 skeleton mt-2">
              <tr class="table-row order_body acc_setting_table skeleton">
                ...
                <th id="th_sort" class="tableHead table_th_color tot_pending_ col skeleton ps-1 pt-1" style="text-align: left;">{{__('translate.Group-Name')}}</th>
