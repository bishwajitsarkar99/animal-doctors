    ...
    $(document).ready(() => {
                ...
                return `
                    <tr>
                        <td class="error_data" align="center" text-danger colspan="11">
                            ...
                            Search medicine group not exists on server <span style="color:rgb(220, 53, 69)">!</span>
                        </td>
                    </tr>
                `;
            }
            ...
            return [...rows].map((row, key) => {
                ...
                return `
                    <tr class="table-row user-table-row" id="group_td" key="${key}">
                        ...
                        <td class="txt_ center" id="group_td3">
                            <div class="dropdown">
                        ...
                        <td class="tot_complete_ center line_height_three" id="group_td5">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        groups_id.append(`<label class="label_user_edit"> Group-ID : <span class="word_space">${response.messages.id}</span></label>`);
                        groups_name.append(`<label class="label_user_edit"> Group-Name : <span class="word_space">${response.messages.group_name}</span></label>`);
                    }
                }
            });
        });
        ...
        $(document).on('click', '#update_btn', function(e){
            ...
            time = setTimeout(() => {
                ...
                $("#groups_name").removeClass('skeleton');
