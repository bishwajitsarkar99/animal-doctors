        ...
        <div class="card-body focus-color cd cat_form">
          ...
          <div class="table-responsive">
            <table class="ord_table center border-1 skeleton mt-2">
              ...
              <tbody class="bg-white skeleton" id="product_data_table">
      ...
      <div class="modal-body profile-body pb-1">
        ...
        <div class="row profile-heading pb-3">
          <div class="col-xl-122">
            <div class="form-group delete_content" id="pro_delt">
              ...
              <input type="text" class="mt-3 update_id id" id="delete_product_id" readonly><br>
