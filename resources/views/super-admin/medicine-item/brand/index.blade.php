        ...
        <div class="card-body focus-color cd cat_form">
          <p class="catg skeleton mb-1">
            ...
            <span class="tot_summ skeleton" id="num_plate">
              ...
              <label class="badge rounded-pill bg-primary" for="total_medic_records skeleton" id="iteam_label4" style="font-size: 11px;"><span class="total_users skeleton" style="font-weight: 600;" id="total_brand_records"></span><span id="iteam_label5" style="font-weight: 600;color:white;">.00 {{__('translate.items')}}</span></label>
            </span>
          </p>
          <div class="row">
            <div class="col-5">
            ...
            <div class="col-2 link">
              <button class="btn btn-sm cgt_btn btn_focus min-skeleton ms-3" type="button" id="showOrigin">{{__('translate.Origin')}}</button>
            </div>
          </div>
          <div>
            <table class="ord_table center border-1 skeleton mt-2">
              <tr class="table-row order_body acc_setting_table skeleton">
                ...
                <th id="th_sort" data-coloumn="id" data-order="desc" class="tableHead table_th_color txt skeleton ps-1 pt-1">{{__('translate.Origin')}}</th>
                <th id="th_sort" class="tableHead table_th_color tot_pending_ col skeleton ps-1 pt-1" style="text-align: left;">{{__('translate.Brand-Name')}}</th>
            ...
            <div class="card form-control cat_form skeleton">
              <form autocomplete="off">
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-6">
                    <input class="form-control form-control-sm orgn_id edit_origin_id skeleton" type="number" name="origin_id" id="origin_id" placeholder="{{__('translate.Origin ID')}}" required>
                  </div>
                  <span id="savForm_error"></span><span id="updateForm_errorList"></span>
                </div>
            ...
            <table class="ord_table center border-1 mt-1" id="orgin_nam">
              <thead id="origin_nam2">
                <tr id="origin_nam3" style="color:black;">
                  ...
                  <th id="origin_nam5" class="tableHead back_color ps-1">{{__('translate.Origin Name')}}</th>
                </tr>
              </thead>
              ...
              <div class="row table_last_row">
                ...
                <div class="col-10">
                  <span class="tot_summ" style="float: right;" id="num_plate">
                    <label class="tot-search mt-3" style="font-size: 12px;font-family:sans-serif;" for="tot_cagt" id="iteam_label3"> {{__('translate.Total Origin Entry')}} :</label>
                    <label class="badge rounded-pill bg-primary item_lab" for="total_medic_records" id="iteam_label4"><span class="total_result" id="total_org_records">
                      </span><span id="iteam_label6" style="font-weight: 600;color:white;font-size:12px;font-family:sans-serif;">.00</span>
                    </label>
                  </span>
                </div>
              </div>
