          ...
          <div>
            <table class="ord_table center border-1 skeleton mt-2">
              <tr class="table-row order_body acc_setting_table skeleton">
                ...
                <th id="th_sort" data-coloumn="id" data-order="desc" class="table_th_color txt skeleton ps-1 pt-1">{{__('translate.Origin')}}</th>
              ...
              <div class="row table_last_row">
                ...
                <div class="col-10">
                  <span class="tot_summ" style="float: right;" id="num_plate">
                    ...
                    <label class="badge rounded-pill bg-primary" for="total_medic_records" id="iteam_label4"><span class="total_result" id="total_org_records">
