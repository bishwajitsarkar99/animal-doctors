...
class EmailVerificationSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['user_id' => 4, 'name' => 'Accounts', 'email' => 'accounts@gmail.com', 'role' => 5, 'email_verified_session' => Carbon::now(), 'account_create_session' =>Carbon::now(), 'status' => 1, 'updated_at' => Carbon::now()],
            ['user_id' => 5, 'name' => 'Marketing', 'email' => 'marketing@gmail.com', 'role' => 6, 'email_verified_session' => Carbon::now(), 'account_create_session' => Carbon::now(), 'status' => 1, 'updated_at' => Carbon::now()],
            ['user_id' => 6, 'name' => 'Delivery-Team', 'email' => 'deliveryteam@gmail.com', 'role' => 7, 'email_verified_session' => Carbon::now(), 'account_create_session' => Carbon::now(), 'status' => 1, 'updated_at' => Carbon::now()],
        ];
