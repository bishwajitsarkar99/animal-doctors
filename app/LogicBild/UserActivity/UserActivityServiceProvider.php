...
class UserActivityServiceProvider
{
    ...
    */
    ...
    //     $login_counts_daily = SessionModel::whereBetween('created_at', [$start, $end])
    //         ->whereNotNull('user_id')
    //         ->where('payload', 'login')
    //         ->select(DB::raw('DATE(created_at) as date'), DB::raw('count(*) as count'))
    //         ->groupBy('date')
    ...
    //     $logout_counts_daily = SessionModel::whereBetween('created_at', [$start, $end])
    //         ->whereNotNull('user_id')
    //         ->where('payload', 'logout')
    //         ->select(DB::raw('DATE(created_at) as date'), DB::raw('count(*) as count'))
    //         ->groupBy('date')
    ...
    //     $current_user_counts_daily = SessionModel::whereBetween('created_at', [$start, $end])
    //         ->whereNotNull('user_id')
    ...
    //         $labels[] = $day;
    //         $logins[] = $login_counts_daily[$day] ?? 0;
    //         $logouts[] = $logout_counts_daily[$day] ?? 0;
    //         $users[] = $current_user_counts_daily[$day] ?? 0;
    //         $period->addDay();
    //     }
    ...
    //         'labels' => $labels,
    //         'login_counts' => $logins,
    //         'logout_counts' => $logouts,
    //         'current_user_counts' => $users,
    //     ]);
    // }
