...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/product-components/category-{slug}/index', [CategoryController::class, 'index'])->name('category.index');
    ...
    // Sub-Category
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/product-components/sub-category-{slug}/index', [SubCategoryController::class, 'index'])->name('sub-category.index');
    ...
    // Medicine-Group
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/medicine-components/medicine-group-{slug}/index', [GroupController::class, 'index'])->name('medicine-group.index');
    ...
    // Medicine-Name
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/medicine-components/medicine-name-{slug}/index', [MedicineNameController::class, 'index'])->name('medicine-name.index');
    ...
    // Medicine-Dosage
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/medicine-components/medicine-dosage-{slug}/index', [MedicineDogsController::class, 'index'])->name('medicine-dogs.index');
    ...
    // Units
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/product-components/units-{slug}/index', [UnitController::class, 'index'])->name('units.index');
    ...
    // Origin
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/product-components/origin-{slug}/index', [MedicineOrginController::class, 'index'])->name('origin.index');
    ...
    // Brand
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/product-components/brand-{slug}/index', [BrandController::class, 'index'])->name('brand.index');
    ...
    // Model
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/product-components/model-{slug}/index', [ProductModelController::class, 'index'])->name('model.index');
    ...
    // Product
    Route::middleware('isSuperAdmin')->group(function () {
        Route::get('/product-components/product-{slug}/index', [ProductController::class, 'index'])->name('product.index');
